...
// Not defined in Wine's xinput.h for some reason
...
#define VPAD_BUTTON_GUIDE            XINPUT_GAMEPAD_GUIDE
...
_Static_assert(sizeof(VpadEvent) == 8, "VpadEvent must be 8 bytes");
